...
{
    public class DivisionService : BasicService<CoreDbContext, Division>, IGeneralUploadService<DivisionViewModel>, IMap<Division, DivisionViewModel>
    {
        ...
        public override Tuple<List<Division>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

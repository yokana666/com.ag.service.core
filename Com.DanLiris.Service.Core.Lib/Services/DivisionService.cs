...
{
    public class DivisionService : StandardEntityService<CoreDbContext, Division>, IGeneralService<Division>, IGeneralUploadService<DivisionViewModel>, IMap<Division, DivisionViewModel>
    {
        ...
        public Tuple<List<Division>, int, Dictionary<string, string>, List<string>> Read(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {
        ...
        public Tuple<bool, List<object>> UploadValidate(List<DivisionViewModel> Data)
        {

...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class DesignMotiveService : BasicService<CoreDbContext, DesignMotive>, IMap<DesignMotive, DesignMotiveViewModel>
    {
        ...
        public override Tuple<List<DesignMotive>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

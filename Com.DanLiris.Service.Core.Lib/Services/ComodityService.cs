...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class ComodityService : BasicService<CoreDbContext, Comodity>, IMap<Comodity, ComodityViewModel>
    {
        ...
        public override Tuple<List<Comodity>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

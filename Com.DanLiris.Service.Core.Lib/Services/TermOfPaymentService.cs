...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class TermOfPaymentService : BasicService<CoreDbContext, TermOfPayment>, IMap<TermOfPayment, TermOfPaymentViewModel>
    {
        ...
        public override Tuple<List<TermOfPayment>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class StorageService : BasicService<CoreDbContext, Storage>, IMap<Storage, StorageViewModel>
    {
        ...
        public override Tuple<List<Storage>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

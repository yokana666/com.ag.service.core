...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class HolidayService : BasicService<CoreDbContext, Holiday>, IMap<Holiday, HolidayViewModel>
    {
        ...
        public override Tuple<List<Holiday>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

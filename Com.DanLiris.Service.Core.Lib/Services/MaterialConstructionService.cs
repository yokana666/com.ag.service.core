   ...
   public class MaterialConstructionService : BasicService<CoreDbContext, MaterialConstruction>, IMap<MaterialConstruction, MaterialConstructionViewModel>
    {
        ...
        public override Tuple<List<MaterialConstruction>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {

...
namespace Com.DanLiris.Service.Core.Lib.Services
{
    public class YarnMaterialService : BasicService<CoreDbContext, YarnMaterial>, IMap<YarnMaterial, YarnMaterialViewModel>
    {
        ...
        public override Tuple<List<YarnMaterial>, int, Dictionary<string, string>, List<string>> ReadModel(int Page = 1, int Size = 25, string Order = "{}", List<string> Select = null, string Keyword = null)
        {
